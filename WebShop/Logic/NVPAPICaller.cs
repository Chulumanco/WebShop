...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-lz43lm3122020_api1.business.example.com";
    private string APIPassword = "ZGGEJE7Y6AZSKYHC";
    private string APISignature = "AyaMyRJzsMmwoAyTRlTekvU9sjimAz8iXZUUi5MaLXkmKAua3cQcMCmN";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "WebShop Payment Application";
        ...
        using (WebShop.Logic.ShoppingCartActions myCartOrders = new WebShop.Logic.ShoppingCartActions())
        {
